...
又は<br/>非課税口座簡易開設届出書</h5>
  ...
  <div class="acc_attention">
    <h6>【ご注意とお願い】</h6>
    <div>お申込みから口座開設までに、通常１～２週間程度お時間をいただきます。<br>ご要望があれば即日にNISA口座を開設し買付することが可能ですが、事後に二重口座であったことが判明した場合、「NISA口座」で買付けした上場株式等は当初から「一般口座」で買付けたものとして 取扱われ、配当所得及び譲渡所得等について課税等の申告が必要になります。<br>提示いただきます本人確認書類はご来店の際に原本をお持ちください。</div>
    <?php /*
    <ul class="list_style_disc">
