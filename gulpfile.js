...
//サイト設定
const themename = "naganosec"; //テーマ名
const localhost = "naganosec.wp"; //サイトURL

//ファイルパス関係
const f_html = "../wp-content/themes/" + themename + "/";
const f_css = "../wp-content/themes/" + themename + "/";
const f_js = "../wp-content/themes/" + themename + "/js/";
const f_image = "img/";
const f_image_min = "../wp-content/themes/" + themename + "/" + f_image;
const f_sass = "sass/";
const f_es6 = "es6/";
const f_es5 = "es5/";
const other = "other/";
